...
import '../../application/use_cases/driver_request_use_cases.dart' as _i40;
...
import '../../application/use_cases/profile_use_case.dart' as _i43;
import '../../application/use_cases/request_service_use_case.dart' as _i42;
import '../../application/use_cases/service_action_use_cases.dart' as _i15;
import '../../src.dart' as _i39;
...
import '../domain/services/call_client_service.dart' as _i37;
...
import '../firebase/repositories/firebase_user_repository.dart' as _i36;
...
import '../firebase/services/firebase_service_driver_action_service.dart'
    as _i28;
import '../firebase/services/firebase_upload_file_service.dart' as _i35;
...
import '../sqflite/services/find_known_address_service.dart' as _i41;
import '../uuid/generate_uuid_service.dart' as _i23;
import 'dependecies.dart' as _i44;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i9.IQualifyRequestServiceService>(() =>
        _i33.FirebaseQualifyRequestServiceService(gh<_i9.FirebaseFirestore>()));
    gh.factory<_i9.IQualifyRequestServiceUseCase>(() =>
        _i15.QualifyRequestServiceUseCase(
            qualifyRequestServiceService:
                gh<_i9.IQualifyRequestServiceService>()));
    ...
    gh.factory<_i9.ITravelPointRepository>(
        () => _i34.SqfliteTravelPointRepository(gh<_i4.Database>()));
    ...
    gh.factory<_i9.IUploadFile>(() => _i35.FirebaseUploadFileService(
        firebaseStorage: gh<_i9.FirebaseStorage>()));
    gh.factory<_i9.IUserRepository>(() =>
        _i36.FirebaseUserRepository(firestore: gh<_i9.FirebaseFirestore>()));
    ...
    gh.factory<_i9.ICallClientService>(
        () => _i37.CallClientService(gh<_i9.ICallService>()));
    ...
    gh.factory<_i9.IFetchDriverRequestUseCase>(() =>
        _i38.FetchDriverRequestUseCase(
            driverRequestService: gh<_i9.IGetDriverRequestService>()));
    gh.factory<_i39.IFinishDriverRequestUseCase>(
        () => _i40.FinishDriverRequestUseCase(
              driverRequestService: gh<_i39.IFinishDriverRequestService>(),
              userService: gh<_i39.IUserRepository>(),
            ));
    gh.factory<_i9.IGetKnownAddressesService>(() =>
        _i41.SqfliteGetKnownAddressesService(gh<_i9.ITravelPointRepository>()));
    ...
    gh.factory<_i9.IGetPaymentsUseCase>(
        () => _i42.GetPaymentsUseCase(gh<_i9.IPaymentRepository>()));
    ...
    gh.factory<_i9.ISaveAddressService>(
        () => _i41.SqfliteSaveAddressService(gh<_i9.ITravelPointRepository>()));
    gh.factory<_i9.ISaveAddressUseCase>(
        () => _i25.SaveAddressUseCase(gh<_i9.ISaveAddressService>()));
    gh.factory<_i39.ISendAboutCarSectionUseCase>(
        () => _i40.SendAboutCarSectionUseCase(
              aboutCarSectionService: gh<_i39.IAboutCarSectionService>(),
              userService: gh<_i39.IUserRepository>(),
              uploadFile: gh<_i39.IUploadFile>(),
            ));
    gh.factory<_i39.ISendAboutMeSectionUseCase>(
        () => _i40.SendAboutMeSectionUseCase(
              aboutMeSectionService: gh<_i39.IAboutMeSectionService>(),
              userService: gh<_i39.IUserRepository>(),
              uploadFile: gh<_i39.IUploadFile>(),
            ));
    gh.factory<_i9.ISendCounterOfferUseCase>(() => _i15.SendCounterOfferUseCase(
        serviceActionService: gh<_i9.IServiceDriverActionService>()));
    gh.factory<_i39.ISendDNISectionUseCase>(() => _i40.SendDNISectionUseCase(
          dniSectionService: gh<_i39.IDNISectionService>(),
          userService: gh<_i39.IUserRepository>(),
          uploadFile: gh<_i39.IUploadFile>(),
        ));
    gh.factory<_i39.ISendDriverLicenseSectionUseCase>(() =>
        _i40.SendDriverLicenseSectionUseCase(
          driverLicenseSectionService: gh<_i39.IDriverLicenseSectionService>(),
          userService: gh<_i39.IUserRepository>(),
          uploadFile: gh<_i39.IUploadFile>(),
        ));
    gh.factory<_i39.ISendDriverRequestUseCase>(
        () => _i40.SendDriverRequestUseCase(
              driverRequestService: gh<_i39.ISendDriverRequestService>(),
              userService: gh<_i39.IUserRepository>(),
            ));
    gh.factory<_i39.ISendNoCriminalRecordSectionUseCase>(
        () => _i40.SendNoCriminalRecordSectionUseCase(
              noCriminalRecordSectionService:
                  gh<_i39.INoCriminalRecordSectionService>(),
              userService: gh<_i39.IUserRepository>(),
              uploadFile: gh<_i39.IUploadFile>(),
            ));
    gh.factory<_i39.ISendOwnerShipCardSectionUseCase>(() =>
        _i40.SendOwnerShipCardSectionUseCase(
          ownerShipCardSectionService: gh<_i39.IOwnerShipCardSectionService>(),
          userService: gh<_i39.IUserRepository>(),
          uploadFile: gh<_i39.IUploadFile>(),
        ));
    ...
    gh.factory<_i39.ISendSoatSectionUseCase>(() => _i40.SendSoatSectionUseCase(
          soatSectionService: gh<_i39.ISoatSectionService>(),
          userService: gh<_i39.IUserRepository>(),
          uploadFile: gh<_i39.IUploadFile>(),
        ));
    gh.factory<_i39.ISendTechnicalReviewSectionUseCase>(
        () => _i40.SendTechnicalReviewSectionUseCase(
              technicalReviewSectionService:
                  gh<_i39.ITechnicalReviewSectionService>(),
              userService: gh<_i39.IUserRepository>(),
              uploadFile: gh<_i39.IUploadFile>(),
            ));
    ...
    gh.factory<_i9.IUpdateProfileUseCase>(() =>
        _i43.UpdateProfileUseCase(userRepository: gh<_i9.IUserRepository>()));
...
class _$AudioPlayerModule extends _i44.AudioPlayerModule {}

class _$DatabaseModule extends _i44.DatabaseModule {}

class _$DioModule extends _i44.DioModule {}

class _$FirebaseAppModule extends _i44.FirebaseAppModule {}

class _$AppCheckModule extends _i44.AppCheckModule {}

class _$FirebaseAuthModule extends _i44.FirebaseAuthModule {}

class _$FirestoreModule extends _i44.FirestoreModule {}

class _$FirebaseStorageModule extends _i44.FirebaseStorageModule {}

class _$FlutterLocalNotificationModule
    extends _i44.FlutterLocalNotificationModule {}

class _$GoogleSignInModule extends _i44.GoogleSignInModule {}
