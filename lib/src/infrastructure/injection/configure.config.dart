...
import '../../application/use_cases/driver_request_use_cases.dart' as _i41;
...
import '../../application/use_cases/profile_use_case.dart' as _i44;
import '../../application/use_cases/request_service_use_case.dart' as _i43;
import '../../application/use_cases/service_action_use_cases.dart' as _i15;
import '../../src.dart' as _i40;
...
import '../device/services/permission_service.dart' as _i31;
...
import '../sqflite/repositories/sqflite_travel_point_repository.dart' as _i35;
import '../sqflite/services/find_known_address_service.dart' as _i42;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i9.IOwnerShipCardSectionService>(() =>
        _i10.FirebaseOwnerShipSectionService(
            firebaseFirestore: gh<_i9.FirebaseFirestore>()));
    gh.factory<_i9.IPayRequestServiceWithPointsService>(
        () => _i29.FirebasePayRequestServiceWithPointsService(
    ...
    gh.factory<_i9.IPayRequestServiceWithPointsUseCase>(() =>
        _i15.PayRequestServiceWithPointsUseCase(
            payRequestServiceWithPointsService:
                gh<_i9.IPayRequestServiceWithPointsService>()));
    gh.factory<_i9.IPaymentRepository>(
        () => _i30.FirebasePaymentRepository(gh<_i9.FirebaseFirestore>()));
    gh.lazySingleton<_i9.IPermissionService>(
        () => _i31.DevicePermissionService());
    gh.factory<_i9.IPlaySound>(() => _i32.AudioPlayerPlaySound());
    gh.factory<_i9.IProfileService>(() =>
        _i33.FirebaseProfileService(firestore: gh<_i9.FirebaseFirestore>()));
    gh.factory<_i9.IQualifyRequestServiceService>(() =>
        _i34.FirebaseQualifyRequestServiceService(gh<_i9.FirebaseFirestore>()));
    ...
    gh.factory<_i9.ITravelPointRepository>(
        () => _i35.SqfliteTravelPointRepository(gh<_i4.Database>()));
    ...
    gh.factory<_i9.IUploadFile>(() => _i36.FirebaseUploadFileService(
        firebaseStorage: gh<_i9.FirebaseStorage>()));
    gh.factory<_i9.IUserRepository>(() =>
        _i37.FirebaseUserRepository(firestore: gh<_i9.FirebaseFirestore>()));
    ...
    gh.factory<_i9.ICallClientService>(
        () => _i38.CallClientService(gh<_i9.ICallService>()));
    ...
    gh.factory<_i9.IFetchDriverRequestUseCase>(() =>
        _i39.FetchDriverRequestUseCase(
            driverRequestService: gh<_i9.IGetDriverRequestService>()));
    gh.factory<_i40.IFinishDriverRequestUseCase>(
        () => _i41.FinishDriverRequestUseCase(
              driverRequestService: gh<_i40.IFinishDriverRequestService>(),
              userService: gh<_i40.IUserRepository>(),
            ));
    gh.factory<_i9.IGetKnownAddressesService>(() =>
        _i42.SqfliteGetKnownAddressesService(gh<_i9.ITravelPointRepository>()));
    ...
    gh.factory<_i9.IGetPaymentsUseCase>(
        () => _i43.GetPaymentsUseCase(gh<_i9.IPaymentRepository>()));
    ...
    gh.factory<_i9.ISaveAddressService>(
        () => _i42.SqfliteSaveAddressService(gh<_i9.ITravelPointRepository>()));
    gh.factory<_i9.ISaveAddressUseCase>(
        () => _i25.SaveAddressUseCase(gh<_i9.ISaveAddressService>()));
    gh.factory<_i40.ISendAboutCarSectionUseCase>(
        () => _i41.SendAboutCarSectionUseCase(
              aboutCarSectionService: gh<_i40.IAboutCarSectionService>(),
              userService: gh<_i40.IUserRepository>(),
              uploadFile: gh<_i40.IUploadFile>(),
            ));
    gh.factory<_i40.ISendAboutMeSectionUseCase>(
        () => _i41.SendAboutMeSectionUseCase(
              aboutMeSectionService: gh<_i40.IAboutMeSectionService>(),
              userService: gh<_i40.IUserRepository>(),
              uploadFile: gh<_i40.IUploadFile>(),
            ));
    gh.factory<_i9.ISendCounterOfferUseCase>(() => _i15.SendCounterOfferUseCase(
        serviceActionService: gh<_i9.IServiceDriverActionService>()));
    gh.factory<_i40.ISendDNISectionUseCase>(() => _i41.SendDNISectionUseCase(
          dniSectionService: gh<_i40.IDNISectionService>(),
          userService: gh<_i40.IUserRepository>(),
          uploadFile: gh<_i40.IUploadFile>(),
        ));
    gh.factory<_i40.ISendDriverLicenseSectionUseCase>(() =>
        _i41.SendDriverLicenseSectionUseCase(
          driverLicenseSectionService: gh<_i40.IDriverLicenseSectionService>(),
          userService: gh<_i40.IUserRepository>(),
          uploadFile: gh<_i40.IUploadFile>(),
        ));
    gh.factory<_i40.ISendDriverRequestUseCase>(
        () => _i41.SendDriverRequestUseCase(
              driverRequestService: gh<_i40.ISendDriverRequestService>(),
              userService: gh<_i40.IUserRepository>(),
            ));
    gh.factory<_i40.ISendNoCriminalRecordSectionUseCase>(
        () => _i41.SendNoCriminalRecordSectionUseCase(
              noCriminalRecordSectionService:
                  gh<_i40.INoCriminalRecordSectionService>(),
              userService: gh<_i40.IUserRepository>(),
              uploadFile: gh<_i40.IUploadFile>(),
            ));
    gh.factory<_i40.ISendOwnerShipCardSectionUseCase>(() =>
        _i41.SendOwnerShipCardSectionUseCase(
          ownerShipCardSectionService: gh<_i40.IOwnerShipCardSectionService>(),
          userService: gh<_i40.IUserRepository>(),
          uploadFile: gh<_i40.IUploadFile>(),
        ));
    ...
    gh.factory<_i40.ISendSoatSectionUseCase>(() => _i41.SendSoatSectionUseCase(
          soatSectionService: gh<_i40.ISoatSectionService>(),
          userService: gh<_i40.IUserRepository>(),
          uploadFile: gh<_i40.IUploadFile>(),
        ));
    gh.factory<_i40.ISendTechnicalReviewSectionUseCase>(
        () => _i41.SendTechnicalReviewSectionUseCase(
              technicalReviewSectionService:
                  gh<_i40.ITechnicalReviewSectionService>(),
              userService: gh<_i40.IUserRepository>(),
              uploadFile: gh<_i40.IUploadFile>(),
            ));
    ...
    gh.factory<_i9.IUpdateProfileUseCase>(() =>
        _i44.UpdateProfileUseCase(userRepository: gh<_i9.IUserRepository>()));
